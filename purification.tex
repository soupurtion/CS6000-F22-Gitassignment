...
\\
\textbf{Answer 1:}
My primary focus will be on 5G & 6G mobile network security. I also have plan to include machine learning in this.
Network Function Virtualization is a way to virtualize network services, i.e. replacing the vendor specific hardware devices with off virtual machines running on top of off the self hardwares.
